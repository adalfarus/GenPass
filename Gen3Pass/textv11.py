...
from utils.db import lock_database
from utils.db import unlock_database
...
def lock_database_wrapper():
    ...
    lock_database("passwords.db", master_password)
    
def unlock_database_wrapper():
    master_password = get_master_password()
    unlock_database("passwords.db", master_password)
...
if __name__ == "__main__":
    ...
    printc("[blue]Gen4Pass[/blue] TextV1 [yellow]v4.0.0.0[/yellow]\nCreated by Adalfarus\n")
    main()
