...
print("Gen1Pass v1.0.2.1")
print("Created by []")
print(" ")

def get_pass_type():
    pass_type = int(input("0:Choose own Characters\n1:Without (a) Type/s of Characters\n2:With all Characters\n3:With a sentence\nWhat kind of Password do you want? : "))
    return pass_type

def configure_from_pass_type(pass_type):
    if pass_type == 0:
...
pass_type = get_pass_type()
letters, digits, specialchar, specharacters, exclude_symbols = configure_from_pass_type(pass_type)
